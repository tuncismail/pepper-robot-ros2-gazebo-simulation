#!/usr/bin/env python3
"""Launch Pepper in Gazebo with the office-with-people world.
...
def generate_launch_description():
    ...
    world_file = os.path.join(pepper_gazebo_pkg, 'worlds', 'simple_office_with_people.world')
    ...
    laser_publisher    = Node(package='pepper_gazebo_plugin',
                              executable='laser_publisher.py',    name='laser_publisher',    output='screen')
    odom_publisher     = Node(package='pepper_gazebo_plugin',
                              executable='odom_publisher.py',     name='odom_publisher',     output='screen')
    ...
    return LaunchDescription([
        ...
        joint_state_broadcaster_spawner, head_controller_spawner, pelvis_controller_spawner,
        left_arm_controller_spawner, right_arm_controller_spawner,
        laser_publisher, odom_publisher, rviz_node,
    ])
